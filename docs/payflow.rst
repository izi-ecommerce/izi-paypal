...
fully integrated IZI site.

Note that in an IZI site, you should only consume the API of the
...
To use Payflow Pro without an IZI install, you need to use the
``paypal.payflow.gateway`` module directly.  This module is agnostic of IZI
and can be used independently.  

The ``paypal.payflow.facade`` module is a bridging module that provides a
simpler API designed to link IZI to the gateway module.
