...
from izi.core.exceptions import ModuleNotFoundError
...
# Upgrading notes: when we drop support for IZI 0.6, this class can be
...
class SuccessResponseView(PaymentDetailsView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        We fetch the txn details again and then proceed with izi's standard
